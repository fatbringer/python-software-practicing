...
rooms_dict = Counter(rooms)  #Counter(rooms) is a dictionary.
#counter is part of the collections library

for key,value in rooms_dict.items():  
    #using dictonary_name.items() which gives you key (key, value) tuples:
